...
PARENT=networks.nets['bigbullions'],
...
IDENTIFIER='fc70135c700a00ed'.decode('hex'),
PREFIX='9472ef181e88efcd'.decode('hex'),
P2P_PORT=5577,
MIN_TARGET=0,
MAX_TARGET=2**256//2**20 - 1,
PERSIST=True,
WORKER_PORT=5579,
BOOTSTRAP_ADDRS='meziti.nl'.split(' '),
...
nets = dict(
    bitcoin=math.Object(
        ...
        SPREAD=3, # blocks
        IDENTIFIER='fd70035c7a81bc6f'.decode('hex'),
        PREFIX='24s2ef181efcd37b'.decode('hex'),
        P2P_PORT=12024,
        MIN_TARGET=0,
